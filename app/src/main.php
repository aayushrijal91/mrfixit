        ...
        <div class="container">
            <div class="row justify-content-center justify-content-lg-between align-items-center">
                ...
                <div class="col-12 col-md-auto">
                    <div class="row gx-2">
                        <div class="col-12 col-md-auto">
                            <a href="tel:<?= $phone_number ?>" class="btn btn-white text-secondary fw-700 py-lg-3 px-md-5 rounded-2 fs-13 font-helvetica">
                                Call <?= $phone_number ?>
                            </a>
                        </div>
                        <div class="col-12 col-md-auto">
                            <a href="#form" class="btn btn-primary text-white fw-700 py-lg-3 px-md-5 rounded-2 fs-13 font-helvetica">
                                Get Free Quote
                            </a>
                        </div>
                    </div>
...
<section class="awards bg-light">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-auto">
                <div class="letter-spacing-n03 text-tertiary fs-8"><span class="fw-700">Leaking tank?</span> Don't Replace Call Now &<span class="fw-700"> Save $$$</span></div>
            </div>
            <div class="col-lg-4 d-flex justify-content-between align-items-center">
                <?= renderImg("watermark.png", "logo") ?>
                <?= renderImg("energy-efficient.png", "logo") ?>
                <?= renderImg("local-bussiness-award.png", "logo") ?>
                <?= renderImg("australian-achiever.png", "logo") ?>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-9 col-xl-8 text-center">
                ...
                <div class="text-tertiary fw-900 fs-3 text-capitalize">
        ...
        <div class="row g-3 py-5">
            <div class="col-lg-6">
                <div class="service-card">
                    ...
                    <div class="overlay">
                        <div class="row gx-4 gx-lg-6 align-items-end justify-content-between">
                            <div class="col">
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto">
                <div class="row">
                    <div class="col-auto">
                        <a href="#form" class="btn border-tertiary text-tertiary fw-700 py-lg-3 px-md-4 px-xl-6 rounded-2 fs-12 font-helvetica">
                            Call Us
                        </a>
                    </div>
                    <div class="col-auto">
...
<section class="our-areas bg-primary text-white">
    <div class="container">
        ...
        <div class="row justify-content-between fs-10 pt-4">
            <div class="col-auto">
